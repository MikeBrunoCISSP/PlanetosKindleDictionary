...
Lets any visitor — logged in or not — search across every dictionary's entries from the search page and find the right entry even when they only know an inflected form of the word.
...
#### Scenario: First visit to the search page
