...
describe("sanitizeDefinitionHtml", () => {
    it("passes through allowed tags unchanged", () => {
        const input = "<p>A <b>channeler</b> bound to the <i>White Tower</i> by the <em>Three Oaths</em>. <strong>See</strong> also<sup>1</sup><sub>2</sub>.</p><ul><li>one</li></ul><ol><li>two</li></ol><span>note</span><br />";
