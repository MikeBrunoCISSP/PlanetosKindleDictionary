...
describe("buildOpf", () => {
    ...
    it("lists manifest items and spine itemrefs for every given file, in order", () => {
        const opf = buildOpf(series, [
            { id: "about", path: "about.xhtml" },
            { id: "content-a", path: "content-a.xhtml" },
        ], "00000000-0000-0000-0000-000000000000", new Date("2026-08-21"));
    ...
    it("escapes special characters in the series title", () => {
        const opf = buildOpf({ ...series, title: "A & B" }, [], "00000000-0000-0000-0000-000000000000", new Date("2026-08-21"));
        expect(opf).toContain("A &amp; B");
    });
});
//# sourceMappingURL=opf.test.js.map